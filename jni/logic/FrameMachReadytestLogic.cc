 ...
 *             停止运行当前定时器
 */
static const char *AnimationPrefix = "ui/animation/handletest_";
#define AnimationMaxNum  2
static bool onUI_Timer(int id){
	...
	case 1:
		...
		g_animationCnt = (g_animationCnt + 1)%AnimationMaxNum;
		mTextviewMachReadytestAnimationPtr->setBackgroundPic(Animationpath);
		break;
		default:
			break;
	}
 ...
 *            触摸事件将继续传递到控件上
 */
static bool onFrameMachReadytestActivityTouchEvent(const MotionEvent &ev) {
